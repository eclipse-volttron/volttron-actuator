...
from actuator.scheduler import (
    PRIORITY_HIGH,
    PRIORITY_LOW,
...
def test_basic():
    ...
    ag = ('Agent1', 'Task1',
          (['campus/building/rtu1',
            ...
            parse('2013-11-27 13:00:00')], ), PRIORITY_HIGH, now)
...
def test_two_agents_two_devices():
    ...
    ag1 = ('Agent1', 'Task1',
           (['campus/building/rtu1',
             parse('2013-11-27 12:00:00'),
             parse('2013-11-27 12:30:00')], ), PRIORITY_HIGH, now)
    ag2 = ('Agent2', 'Task2',
           (['campus/building/rtu2',
             parse('2013-11-27 12:00:00'),
             parse('2013-11-27 13:00:00')], ), PRIORITY_HIGH, now)
    ...
    assert all(
        (success2, not data2, not info_string2, event_time2 == parse('2013-11-27 12:00:00')))
...
def test_touching_requests():
    ...
    assert all(
        (success1, not data1, not info_string1, event_time1 == parse('2013-11-27 12:00:00')))
    result2, event_time2 = verify_add_task(sch_man, *ag2)
    success2, data2, info_string2 = result2
    assert all(
        (success2, not data2, not info_string2, event_time2 == parse('2013-11-27 12:00:00')))
...
def test_malformed_schdeule_bad_timestr():
    ...
    ag = ('Agent1', 'Task1',
          (['campus/building/rtu1', 'fdhkdfyug',
            'Twinkle, twinkle, little bat...'], ), PRIORITY_HIGH, now)
...
def test_malformed_bad_device():
    ...
    sch_man = ScheduleManager(60, now=now)
    ag = ('Agent1', 'Task1', ([1, parse('2013-11-27 12:00:00'),
...
def test_schedule_conflict():
    ...
    assert conflicts2 == {
        'Agent1': {
            'Task1': [['campus/building/rtu1', '2013-11-27 12:00:00', '2013-11-27 12:35:00']]
        }
    }
...
def test_conflict_override():
    ...
    ag1 = ('Agent1', 'Task1',
           (['campus/building/rtu1',
             parse('2013-11-27 12:00:00'),
             parse('2013-11-27 12:35:00')], ), PRIORITY_LOW, now)
    ag2 = ('Agent2', 'Task2',
           (['campus/building/rtu1',
             parse('2013-11-27 12:30:00'),
             parse('2013-11-27 13:00:00')], ), PRIORITY_HIGH, now)
...
def test_conflict_override_fail_on_running_agent():
    ...
    ag2 = ('Agent2', 'Task2',
           (['campus/building/rtu1',
             parse('2013-11-27 12:30:00'),
             parse('2013-11-27 13:00:00')], ), PRIORITY_HIGH, now + timedelta(minutes=45))
    result1, event_time1 = verify_add_task(sch_man, *ag1)
    success1, data1, info_string1 = result1
...
def test_conflict_override_success_running_agent():
    ...
    ag1 = ('Agent1', 'Task1',
           (['campus/building/rtu1',
             parse('2013-11-27 12:00:00'),
             parse('2013-11-27 12:35:00')], ), PRIORITY_LOW_PREEMPT, now)
    now2 = now + timedelta(minutes=45)
    ag2 = ('Agent2', 'Task2',
           (['campus/building/rtu1',
             parse('2013-11-27 12:05:00'),
             parse('2013-11-27 13:00:00')], ), PRIORITY_HIGH, now2)
    result1, event_time1 = verify_add_task(sch_man, *ag1)
    success1, data1, info_string1 = result1
    assert all(
        (success1, not data1, not info_string1, event_time1 == parse('2013-11-27 12:00:00')))
...
def test_conflict_override_error():
    print(
        'Test conflicting requests: Agent2 fails to override running Agent1 because of non high priority.',
        now)
    sch_man = ScheduleManager(60, now=now)
    ag1 = ('Agent1', 'Task1',
           (['campus/building/rtu1',
    ...
    ag2 = ('Agent2', 'Task2',
           (['campus/building/rtu1',
             parse('2013-11-27 12:30:00'),
             parse('2013-11-27 13:00:00')], ), PRIORITY_LOW, now)
    result1, event_time1 = verify_add_task(sch_man, *ag1)
    success1, data1, info_string1 = result1
    assert all(
        (success1, not data1, not info_string1, event_time1 == parse('2013-11-27 12:00:00')))
